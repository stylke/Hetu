...
if(${USE_FLASH_ATTN})
  ...
  ExternalProject_Add(project_flashattn
    ...
    CMAKE_ARGS -DCMAKE_BUILD_TYPE=${CMAKE_BUILD_TYPE} -DCMAKE_INSTALL_PREFIX=${FLASH_INSTALL} -DCMAKE_INSTALL_LIBDIR=${FLASH_INSTALL} 
    -DCMAKE_INSTALL_BINDIR=${FLASH_INSTALL}
  )
