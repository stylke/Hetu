...
void mul_elewise_cpu(const spec_t* inputA, const spec_t* inputB, size_t size,
                     spec_t* output) {
#ifdef _OPENMP
...
template <typename spec_t>
void mul_elewise_broadcast_cpu(const spec_t* inputA, const spec_t* inputB,
  ...
  if (sizeA == sizeB) {
    ...
    HT_DISPATCH_INTEGER_AND_FLOATING_TYPES(
      inputA->dtype(), spec_t, "MulElewiseCuda", [&]() {
        mul_elewise_cpu<spec_t>(inputA->data_ptr<spec_t>(),
    ...
    HT_DISPATCH_INTEGER_AND_FLOATING_TYPES(
      inputA->dtype(), spec_t, "MulElewiseCuda", [&]() {
        mul_elewise_broadcast_cpu<spec_t>(
