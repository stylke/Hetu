...
reduce_mean_kernel(const spec_t* input, spec_t* output, int ndim_input,
                   ...
                   int64_t* strides_reduce, int64_t* stride_rest,
                   int64_t* shape_in, int64_t* shape_rest, int64_t* shape_reduce,
                   int64_t* reduce_dims, int64_t* rest_dims, int reduce_num) {
