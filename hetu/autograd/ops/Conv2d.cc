...
void Conv2dGradientofFilterOpDef::DeduceStates() {
  DistributedStates ds_input = _inputs[0]->get_distributed_states();
...
void Conv2dGradientofDataOpDef::DeduceStates() {
...
void Conv2dAddBiasOpDef::DeduceStates() {
  DistributedStates ds_input = _inputs[0]->get_distributed_states();
  DistributedStates ds_filter = _inputs[1]->get_distributed_states();
