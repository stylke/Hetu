...
// void EinsumOpImpl::DoCompute(const NDArrayList& inputs, NDArrayList& outputs,
//                             RuntimeContext& ctx) {
...
// TensorList EinsumOpImpl::DoGradient(const TensorList& grad_outputs) {
//   int len = num_inputs();
...
// void EinsumGradientOpImpl::ParseMsg(const HTShapeList& input_shapes) {
//   input_dims = {};
//   output_dims = {};
//   _input_msgs = {};
//   _output_msg = {};
...
// void EinsumGradientOpImpl::DoCompute(const NDArrayList& inputs,
...
// void EinsumGradientOpImpl::DoInferMeta() {
//   HT_ASSERT_TENSORS_SAME_DTYPE(_inputs);
//   AddOutput(NDArrayMeta().set_dtype(_inputs[0]->dtype()).set_device(_inputs[0]->device()));
// }

// HTShapeList EinsumGradientOpImpl::DoInferShape(const HTShapeList& input_shapes) {
