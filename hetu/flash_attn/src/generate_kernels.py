...
KERNEL_IMPL_TEMPLATE_FWD = """#include "hetu/flash_attn/src/flash_fwd_launch_template.h"
...
KERNEL_IMPL_TEMPLATE_FWD_SPLIT = """#include "hetu/flash_attn/src/flash_fwd_launch_template.h"
