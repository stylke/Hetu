...
class GPTAttention(ht.nn.Module):
    ...
    def _attn(self, query, key, value, attention_mask=None, head_mask=None):
        # TODO: Use new matmul instead of bmm
        attn_weights = ht.matmul(query, key.transpose([0,1,3,2]))
        ...
        # TODO: Use new matmul instead of bmm
        attn_output = ht.matmul(attn_weights, value)
