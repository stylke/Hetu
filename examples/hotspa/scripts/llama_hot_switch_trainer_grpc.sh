...
if [ "${SEQ_LEN}" = "32768" ]; then
    ...
    BUCKET_SIZES=(8192 4096 2048 0)
    ALL_PARALLEL_STRATEGY=("2,4,1" "8,1,1" "4,2,1")
...
CMD="python3 llama_hot_switch_trainer.py \
...
SERVER_ADDR=xx.xx.xx.xx # master/worker ip
SERVER_PORT=23457
