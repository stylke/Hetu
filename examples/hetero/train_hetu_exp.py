...
def kill_command():
    # 定义包含所有主机的文件
    hosts_file = '/home/pkuhetu/lhy/multi_switch/examples/nlp/gpt/scripts/host.txt'
    # 定义要查找并杀掉的进程的关键字
    process_keyword = 'python3 -u train_hetu_train.py'
    # 使用 pssh 执行远程命令
    return f"pssh -h {hosts_file} -i 'pkill -f \"{process_keyword}\"'"
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--exp_file", type=str, default="", help='exp file path.'
    )
    parser.add_argument(
