...
class FnArg {
 ...
 private:
  ...
  std::vector<std::vector<bool>> _default_bool_list_list;
};
...
class ParsedPyArgs {
 public:
  ...
  inline std::vector<std::vector<bool>> get_bool_list_list(size_t i) const {
    return BoolListList_FromPyBoolListList(_args[i]);
  }
